...
def temp1():
    ...
    response.headers["Set-Cookie"] = "user_http=temp1_http_"+ip_address
    print(response.headers)
    return response
@app.route('/temp2')
def temp2():
    ...
    response.headers["Set-Cookie"] = "user_http=temp2_http_"+ip_address
    print(response.headers)
    return response
@app.route('/temp3')
def temp3():
    ...
    response.headers["Set-Cookie"] = "user_http=temp3_http_"+ip_address
    print(response.headers)
    return response
